...
void LCD_ShowChinese40x40(unsigned int x,unsigned int y,unsigned int fc,unsigned int bc,unsigned char index);//显示单个40x40汉字
...
void DispScreen(unsigned char *dataEPC,unsigned char *dataV,unsigned char *dataA,unsigned char *dataP,unsigned char *dataCOS,unsigned char *dataHZ,unsigned char *dataKWH);
//画笔颜色
#define WHITE         	 0xFFFF
#define BLACK         	 0x0000	  
#define BLUE           	 0x001F  
