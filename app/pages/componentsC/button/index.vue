		...
		<u-row>
			<u-col span="4" offset="1">
				<view class="u-demo-area">
					<u-button @click="btnClick" data-name="3333" :loading="loading" :plain="plain" :shape="shape" :size="size" :ripple="ripple" :hairLine="hairLine" :type="type">开灯</u-button>
				</view>
			</u-col>
			<u-col span="3" offset="2">
				<view class="u-demo-area">
					<u-button @click="btnClick" data-name="3333" :loading="loading" :plain="plain" :shape="shape" :size="size" :ripple="ripple" :hairLine="hairLine" :type="type">关灯</u-button>
				</view>
			</u-col>
		</u-row>
		</view>
